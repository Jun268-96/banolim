...
const sizeClassByVariant: Record<NonNullable<SettingsDialogProps['size']>, string> = {
    md: 'max-w-xl',
    lg: 'max-w-2xl',
    xl: 'max-w-4xl',
};
...
export const SettingsDialog: React.FC<SettingsDialogProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-[80] flex items-end justify-center bg-slate-950/55 px-3 py-3 backdrop-blur-sm sm:items-center sm:px-6 sm:py-8">
            <button
                type="button"
                aria-label="설정 창 닫기"
